...
data class SalatSettings(
    ...
    @ColumnInfo(name = "fajr_alert_active", typeAffinity = ColumnInfo.INTEGER) var fajrAlertActive: Int = 0,
    @ColumnInfo(name = "dhuhr_alert_active", typeAffinity = ColumnInfo.INTEGER) var dhuhrAlertActive: Int = 0,
    @ColumnInfo(name = "asr_alert_active", typeAffinity = ColumnInfo.INTEGER) var asrAlertActive: Int = 0,
    @ColumnInfo(name = "maghrib_alert_active", typeAffinity = ColumnInfo.INTEGER) var maghribAlertActive: Int = 0,
    @ColumnInfo(name = "isha_alert_active", typeAffinity = ColumnInfo.INTEGER) var ishaAlertActive: Int = 0,
